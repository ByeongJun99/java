...
public class B_String {
	public void method01() {
		...
		// String 클래스에 toString 메소드 이미 오버라이딩 되어있음!(실제 담긴 문자열을 반환하도록)
		
		System.out.println(str1 == str2);	// false (주소값 비교라서)
		
		System.out.println(str1.equals(str2));
		// String 클래스에 equals 메소드는 이미 오버라이딩 되어있음(주소값 비교가 아닌 담긴 문자열을 비교하도록)
		
		System.out.println(str1.hashCode());
		System.out.println(str2.hashCode());
		// String 클래스에 hashCode 메소드 이미 오버라이딩 되어있음(주소값이 아닌 문자열을 가지고 만들도록)
...
//		char ch2 = new java.util.Scanner(System.in).next().toUpperCase().charAt(0);	// 'N' 'Y'
...
//		}
	...
	public void method03() {
		String str = "Java, Oracle, JDVC, HTML, CSS, Spring";
