...
public class FileChar {
	...
	public void fileRead() {
		// FileReader : 파일로부터 데이터를 2바이트 단위로 입력받4을 수 있는 스트링
		
//		FileReader fr = null;
		
		// 알아서 try가 다 처리되면 해당 스트림을 반납한다.
		try(FileReader fr = new FileReader("b_char.txt")) {
			// 1. FileReader 객체생성 -> 파일로부터 데이터를 읽어들일 수 있는 통로 연결!
//			fr = new FileReader("b_char.txt");
		...
		/*
		 * try-width-resource구문 => 자원을 자동으로 반납해준다. (finally 필요 없어짐)
		 * 
