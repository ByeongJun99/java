...
//		// Child1에 접근하고자 한다면, 강제 형변환을 통해서 가능!!
		...
		// 다형성 사용 전...
		// Child1객체 2개 Child2객체 2개를 관리해야한다고 가정.
...
//		((Child2)arr[3]).printChild2();
		...
		for(int i=0; i<arr.length; i++) {
			if (arr[i] instanceof Child1) {	// 해당 참조변수가 실제 Child1을 참조하고 있니?(arr[i]가 Child1공간 사용 가능해?)
